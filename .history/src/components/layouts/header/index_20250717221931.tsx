  ...
  return (
    <header className="">
      ...
      <div className="border-[#EEEFF0] border-b-[1px] py-[19px]">
        <div className="flex items-center justify-between py-[19px] container mx-auto bg-amber-300">
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="flex items-center">
              <input
                className="w-60 py-2 px-2.5 border border-[#E5E8EA] rounded-md font-medium text-[14px] translate-x-3"
                type="text"
                placeholder={`${t("navLink9")}`}
              />
              <IoSearch size={20} className=" text-[#211F2E]" />
            </div>
          </div>
        </div>
      </div>
