    ...
    <footer className="bg-[#120E0F] w-full py-6">
      <div className="container mx-auto">
        <div className="flex items-start justify-between my-7">
          <div className="">
            <h2 className="text-[#FF9A50] text-[40px] font-bold mb-12">Logo</h2>
            <div>
              <p className="text-[#dcc7bcd8] font-medium text-[14px] mb-3">hello@logoipsum.com</p>
        ...
        <div className="border-[#F3742D] border-t">
          <p className="text-[#E7C4B1] text-[12px] font-">© 2025 — Copyright</p>
          <p className="text-[#E7C4B1] text-[12px] ">Privacy</p>
        </div>
      </div>
    </footer>
  );
