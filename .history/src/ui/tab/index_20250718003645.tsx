      ...
      <div className="flex flex-col gap-4 border-t border-gray-300">
        <div className="container mx-auto flex items-center justify-between px-20">
          <button
            ...
            className={`py-2 px-4 text-sm font-medium -translate-y-0.5 w-[220px] flex items-center ${
              activeTab === "archive"
          ...
          <button
            ...
            className={`py-2 px-4 text-sm font-medium -translate-y-0.5 w-[220px] flex items-ce ${
              activeTab === "fair"
                ? "border-t-2 border-[#FF9A50] text-[#FF9A50]"
                :"text-[#3d3a39]"
            }`}
