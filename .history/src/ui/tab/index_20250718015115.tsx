...
import { HomeCard } from "@/components/sections/home-sections";
import { NewsCard } from "@/components/sections/news-sections";
import { SamarkandCard } from "@/components/sections/samarkand-sections";
    ...
    <div className="mb-10">
      <div className="flex flex-col gap-4 border-t border-gray-300">
        ...
        <div className="container mx-auto mb-6">
          <h3 className="text-[#211F2E] font-normal text-3xl mb-2.5">{t("title")}</h3>
